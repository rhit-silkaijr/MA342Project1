function [P_o] = points_based_on_input(P,P2,n)
% points_based_on_input
% Takes in a value P and P2, m x 2 vectors of points describing the top and
% bottom of the wing respectively, with endpoints at 0 and 1
